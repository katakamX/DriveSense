...
> **Status: Milestone 1 of 15 — architecture, scaffold, Docker skeleton, CI.**
> The backend serves health endpoints and the frontend renders a status page.
> Telemetry ingest, event detection, ML, computer vision and the risk engine
> are not implemented yet. Nothing in this repository claims functionality it
> does not have.
...
data/        Datasets — gitignored, regenerated by pipelines
```
